...
// 3- Déconnexion
if (isset($_GET['action']) && $_GET['action'] == 'deconnexion'){/* si dans l'URL je récupère action = deconnexion */
...
<body>
    ...
    <?php if(!estConnecte()) {
        ...
        <div class=\"alert alert-success\">
            Vous n'êtes pas connecté, merci de bien vouloir vous rendre sur la page <a href=\"connexion.php\">connexion</a> pour accéder à votre profil.
        </div>";
    } else{ ?>

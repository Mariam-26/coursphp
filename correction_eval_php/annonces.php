...
$requete = $pdoLocation->query(" SELECT * FROM advert ORDER BY id DESC ");
        ...
        <?php if (empty($annonces['reservation_message'])) { ?>
          ...
          <div class="col-12 col-md-6 col-lg-4 mb-5">
            <div class="card text-center shadow">
              ...
              <div class="card-body">
                <h2 class="h4 card-title text-uppercase"><?php echo $annonces['title'] ?></h2>
            ...
            <div class="card text-center shadow position-relative">
              ...
              <div class="card-footer opacity-50">
                ...
                <p><?php
                    ...
                    <span class="position-absolute top-0 translate-middle badge rounded-pill border border-white shadow p-3 bg-secondary text-uppercase">Déjà réservé</span>
                  </div>
                </div>
                <?php } ?>

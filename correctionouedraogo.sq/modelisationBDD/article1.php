...
<main class="container">
  <div class="row col-12">
    ...
    <!-- J'affiche toutes les informations relatives à l'article sélectionné -->
        ...
        <div class="col-12 col-md-6 m-auto alert-warning p-5 rounded">
            ...
            <form action="#" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <!-- POUR LE contenu, JE BOUCLE SUR LES CONTENUS EXISTANTS DANS LA BDD AFIN DE NE PAS AVOIR UN CODE TROP LONG -->
                    <?php
